...
import pl.michal.pizza.remote.rest.dto.request.AddPizzaDto;
...
public class PizzaController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PizzaDto> updatePizza(@RequestBody AddPizzaDto addPizzaDto,@RequestHeader("Access-Token") String token,@PathVariable("id") Integer pizzaId){
        return  ResponseEntity.ok(null);
    }
    @DeleteMapping("/{id}")
